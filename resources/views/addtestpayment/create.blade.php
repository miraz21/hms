...
@section('content')
 <div class="container-fluid page-body-wrapper">
	...
	<div class="col-md-8">
	<h3 class="text-center mt-3">Add Test Payment</h3>
    @if ($errors->any())
...
@endif
<form action="{{route('addtestpayment.store')}}" method="post" enctype="multipart/form-data">
@csrf 
<div class="mb-3">
    <select class="form-select" name="appointment_id" id="appointment_id" style="width:0ch 250px;">
    <option value=" "></option>
