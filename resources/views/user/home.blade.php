...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
            <a href="#"><span class="mai-call text-primary"></span> +8801700778300</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span> rmninursinginstitute@gmail.com</a>
            </div>
          </div>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(image/hospital.jpg);">
    <div class="hero-section">
      ...
      <h1 class="display-4" style="line-height: 0.4">Rezwan Molla General Hospital</h1>
        <h1 class="display-4" style="line-height: 0.4">Specialized Heart Center</h1>
        <h1 class="display-4" style="line-height: 0.4">& Nursing Institute.</h1>
        <a href="#" class="btn btn-primary">24/7 at your service</a>
      </div>
    </div>
  </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp">
            <h1>Welcome to Your Heart <br> Center</h1>
  ...
  <footer class="page-footer">
    <div class="container">
      ...
      <p id="copyright">Copyright &copy; <a href="" target="_blank">Technism International IT Solution Limited 2022</a>. All right reserved</p>
    </div>
  </footer>
