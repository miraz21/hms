	    ...
	    <div class="card-body">
	      <div class="table-responsive">
	        <table class="table table-borderless table-striped table-sm" id="dataTable" width="100%" cellspacing="0">
	          ...
	          <tbody>
	           @foreach($saledetails->unique('appointment_id') as $key=>$saledetail)
		       <tr>
		      ...
		      <td>
				...
				<a href="{{route('saledetails.more',$saledetail->appointment_id)}}" class="btn btn-sm btn-info">More Info</a>
